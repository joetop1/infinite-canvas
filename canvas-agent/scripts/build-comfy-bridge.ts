...
const outputs = {
    windows: path.join(outputDir, "InfiniteCanvas-ComfyBridge.exe"),
    linuxAmd64: path.join(outputDir, "InfiniteCanvas-ComfyBridge-linux-amd64"),
    linuxArm64: path.join(outputDir, "InfiniteCanvas-ComfyBridge-linux-arm64"),
} as const;
